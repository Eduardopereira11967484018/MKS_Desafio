...
>
      <div className='flex flex-col '>
        <div className="flex justify-between p-4 lg:px-8 lg:pt-6 lg:pb-2">
          ...
          <button onClick={CloseCart} className="w-10 h-10 rounded-full bg-black text-white text-xl flex justify-center items-center leading-none hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">X</button>
        </div>
